...
public class N1qlCrudRepositoryIntegrationTests {
	...
	@Autowired private Bucket client;
	...
	private static final Party party = new Party(KEY_PARTY, "partyName", "short description", new Date(), 120,
			new Point(500, 500));
	...
	public void cleanUp() {
		...
		try {
			partyRepository.deleteById(KEY_PARTY_KEYWORD);
		} catch (DataRetrievalFailureException e) {}
	}
	...
	public void shouldSaveObjectWithN1qlKeywordField() {
		Party partyHasKeyword = new Party(KEY_PARTY_KEYWORD, "party", "desc is a N1QL keyword", new Date(), 40,
				new Point(500, 500));
	...
	public void shouldDoNumericProjectionWithStringBasedQuery() {
		Party partyHasKeyword = new Party(KEY_PARTY_KEYWORD, "party", "desc is a N1QL keyword", new Date(), 4000000,
				new Point(500, 500));
		partyRepository.save(partyHasKeyword);
