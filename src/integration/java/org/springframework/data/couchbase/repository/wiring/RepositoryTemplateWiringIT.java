...
public class RepositoryTemplateWiringIT {
  ...
  @Configuration
  @EnableCouchbaseRepositories(basePackageClasses = RepositoryTemplateWiringIT.class, considerNestedRepositories = true)
