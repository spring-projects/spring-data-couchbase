...
public class AbstractCouchbaseDataConfigurationIT {
  ...
  @Configuration
  @EnableCouchbaseRepositories(basePackageClasses = AbstractCouchbaseDataConfigurationIT.class, considerNestedRepositories = true)
