...
public class N1qlRepositoryQueryExecutor {
	...
	public Object execute(final Object[] parameters) {
		...
		ExecutableFindOperation.FindWithProjection<?> operation = (ExecutableFindOperation.FindWithProjection<?>) operations
				.findById(domainClass); // TODO .consistentWith(buildQueryScanConsistency());
