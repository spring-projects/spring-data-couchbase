...
/**
 * A support registrar that allows to set up auditing for Couchbase ({@link AuditingHandler} set up). See
 * {@link EnableCouchbaseAuditing} for the associated annotation.
 *
