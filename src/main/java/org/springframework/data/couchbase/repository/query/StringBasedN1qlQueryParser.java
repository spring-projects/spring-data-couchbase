...
public class StringBasedN1qlQueryParser {
	...
	/**
	 * Use this variable in a SpEL expression in a {@link Queryable @Query} annotation's inline statement. This will be
	...
	/**
	 * Use this variable in a SpEL expression in a {@link Queryable @Query} annotation's inline statement WHERE clause.
