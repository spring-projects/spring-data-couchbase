...
public class N1QLExpression {
    ...
    public N1QLExpression from(String bucketName) { return from(i(bucketName)); }

    public N1QLExpression where(N1QLExpression right) {
        return infix("WHERE", toString(), right.toString());
    }
    public N1QLExpression returning(N1QLExpression right) { return infix("RETURNING", toString(), right.toString()); }
    ...
    public N1QLExpression limit(int limit) { return infix("LIMIT", toString(), String.valueOf(limit));}

    public N1QLExpression offset(int offset) { return infix("OFFSET", toString(), String.valueOf(offset)); }
    /**
