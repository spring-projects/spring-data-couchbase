 ...
 * framework.
 *
 * Each consistency can be translated to a {@link ViewScanConsistency} (for the {@link #viewConsistency() views})
 * and {@link QueryScanConsistency} (for the {@link #n1qlConsistency() N1QL queries}).
 *
 * @author Simon Baslé
 */
