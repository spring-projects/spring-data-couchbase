...
import static org.springframework.data.couchbase.core.query.OptionsBuilder.mostSpecific;
...
public class PseudoArgs<OPTS> {
	...
	public PseudoArgs(ReactiveCouchbaseTemplate template, String scope, String collection, OPTS options,
		...
		scopeForQuery = mostSpecific(null, scopeForQuery, scope, getScopeFrom(domainType));
		collectionForQuery = mostSpecific(null, collectionForQuery, collection, getCollectionFrom(domainType));
		optionsForQuery = mostSpecific(null, options, optionsForQuery);
