...
If you have a general usage question, please do not open a GitHub issue but use one of the other channels https://github.com/spring-projects/spring-data-couchbase#getting-help[described in the readme file].
